...
-- Criar um procedimento armazenado (procedure) para realizar as operações de INSERT, UPDATE E DELETE na tabela de CIDADES. Criar uma procedure única que faça todas as operações.
